...
<body x-data="
    ...
    <div class="container mx-auto">
      <div class="relative flex items-center justify-between -mx-4">
        <div class="relative z-10 max-w-full px-4 py-3 w-60">
          <a href="javascript:void(0)" class="block w-full flex gap-4 items-center sm:-ml-[4rem]">
            <img src="src/images/logo_stifin.webp" alt="logo" class="sm:w-[50%] w-[40%]" />
            <img src="src/images/logo_steps.png" alt="logo" class="sm:w-[75%] w-[40%]" />
          </a>
        ...
        <div class="flex items-center justify-between w-full px-4">
          <div>
            <button @click="navbarOpen = !navbarOpen" :class="navbarOpen && 'navbarTogglerActive' " id="navbarToggler"
              class="absolute right-4 top-1/2 block -translate-y-1/2 rounded-md px-3 py-[6px] text-white bg-primary hover:opacity-75 ring-stroke focus:ring-2">
              Start Now
              <!-- <span
      ...
      <div class="swiper absolute top-0 left-0 z-[-2] h-full w-full">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <img src="src/images/hero.jpg" alt="image" class="h-full w-full object-cover object-center" />
          </div>
          <div class="swiper-slide">
            <img src="src/images/Onna.jpg" alt="image" class="h-full w-full object-cover object-center" />
          </div>
          <div class="swiper-slide">
            <img src="src/images/hero.jpg" alt="image" class="h-full w-full object-cover object-center" />
          </div>
      ...
      <div class="container mx-auto relative z-10">
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4 text-white">
            <h1 class="text-4xl font-bold">Lorem Ipsum Sit Dolor Amet</h1>
            <p class="mt-4 text-lg">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta
              saepe enim necessitatibus.
            </p>
            <div>
        ...
        <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
          <div class="mt-10 lg:mt-0">
            ...
            <p class="mb-5 text-base text-body-color dark:text-dark-6">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum fuga quaerat ducimus aliquam? Veritatis,
              nemo!
            </p>
            <p class="mb-8 text-base text-body-color dark:text-dark-6">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dignissimos sunt libero, animi ex corporis quae.
            </p>
            <a href="javascript:void(0)"
        ...
        <div class="w-full px-4">
          <div class="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
            ...
            <p class="text-base text-body-color dark:text-dark-6">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vitae quo blanditiis cum magnam sit illum!
            </p>
          </div>
        </div>
      </div>
      <div class="flex flex-wrap -mx-4">
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
          <div class="mb-9 rounded-[20px] bg-white dark:bg-dark p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10">
            ...
            <p class="text-body-color dark:text-dark-6">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dignissimos rerum culpa amet esse in error?
            </p>
          </div>
        </div>
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
          <div class="mb-9 rounded-[20px] bg-white dark:bg-dark p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10">
            ...
            <p class="text-body-color dark:text-dark-6">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Enim praesentium animi inventore in aliquam
              quibusdam.
            </p>
          </div>
        </div>
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
          <div class="mb-9 rounded-[20px] bg-white dark:bg-dark p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10">
            ...
            <p class="text-body-color dark:text-dark-6">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates iure ex eaque quam incidunt non!
            </p>
          </div>
        </div>
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
          <div class="mb-9 rounded-[20px] bg-white dark:bg-dark p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10">
            ...
            <p class="text-body-color dark:text-dark-6">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi eligendi labore alias obcaecati deserunt
              nam?
            </p>
          </div>
        </div>
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
          <div class="mb-9 rounded-[20px] bg-white dark:bg-dark p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10">
            ...
            <p class="text-body-color dark:text-dark-6">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis nesciunt necessitatibus dicta amet,
              aspernatur beatae.
            </p>
          </div>
        </div>
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
          <div class="mb-9 rounded-[20px] bg-white dark:bg-dark p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10">
            ...
            <p class="text-body-color dark:text-dark-6">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quod harum odit ex adipisci eveniet totam.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[510px] text-center">
              ...
              <h2
                class="text-dark dark:text-white mb-3 text-3xl leading-[1.208] font-bold sm:text-4xl md:text-[40px]"
              >
                Our Recent Projects
              </h2>
              <p class="text-base text-body-color dark:text-dark-6">
        ...
        <div class="flex flex-wrap -mx-4">
          ...
          >
            <div class="relative mb-12">
              <div class="overflow-hidden rounded-[10px]">
                <img
                  src="src/assets/images/portfolio/portfolio-01/image-01.jpg"
                  alt="portfolio"
                  class="w-full"
                />
              </div>
              ...
              >
                ...
                <a
                  href="javascript:void(0)"
                  class="text-body-color dark:text-dark-6 hover:border-primary hover:bg-primary inline-block rounded-md border border-stroke dark:border-dark-3 py-[10px] px-7 text-sm font-medium transition hover:text-white dark:hover:text-white dark:hover:border-primary"
                >
                  View Details
                </a>
              </div>
          ...
          >
            <div class="relative mb-12">
              <div class="overflow-hidden rounded-[10px]">
                <img
                  src="src/assets/images/portfolio/portfolio-01/image-02.jpg"
                  alt="portfolio"
                  class="w-full"
                />
              </div>
          ...
          >
            <div class="relative mb-12">
              <div class="overflow-hidden rounded-[10px]">
                <img
                  src="src/assets/images/portfolio/portfolio-01/image-03.jpg"
                  alt="portfolio"
                  class="w-full"
                />
              </div>
          ...
          >
            <div class="relative mb-12">
              <div class="overflow-hidden rounded-[10px]">
                <img
                  src="src/assets/images/portfolio/portfolio-01/image-04.jpg"
                  alt="portfolio"
                  class="w-full"
                />
              </div>
          ...
          >
            <div class="relative mb-12">
              <div class="overflow-hidden rounded-[10px]">
                <img
                  src="src/assets/images/portfolio/portfolio-01/image-05.jpg"
                  alt="portfolio"
                  class="w-full"
                />
              </div>
          ...
          >
            <div class="relative mb-12">
              <div class="overflow-hidden rounded-[10px]">
                <img
                  src="src/assets/images/portfolio/portfolio-01/image-06.jpg"
                  alt="portfolio"
                  class="w-full"
                />
              </div>
        ...
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[510px] text-center">
              ...
              <p class="text-base text-body-color dark:text-dark-6">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Fugiat dolorum sit quam nam ea quae?
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="w-full px-4 md:w-1/2 xl:w-1/4">
            <div class="mx-auto mb-10 w-full max-w-[370px]">
              <div class="relative overflow-hidden rounded-lg">
                <img src="src/images/null2.png" alt="image" class="w-full" />
                <div class="absolute left-0 w-full text-center bottom-5">
                  <div
                    class="relative px-3 py-5 mx-5 overflow-hidden bg-white rounded-lg dark:bg-dark-2"
                  >
                    <h3
                      class="text-base font-semibold text-dark dark:text-white"
                    >
                      Coriss Ambady
                    </h3>
    ...
    >
      <div class="mx-auto">
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4">
            <div
              class="mx-auto mb-[60px] max-w-[510px] text-center lg:mb-[75px]"
            >
              <span class="block mb-2 text-lg font-semibold text-primary">
                Pricing Table
              </span>
        ...
        <div class="flex items-end w-full">
          <div class="absolute z-20 overflow-hidden left-0">
            <img src="src/images/gurl.png" alt="" class="w-[50%] hidden lg:inline" />
          </div>
          <div
            class="w-[80%] bg-primary from-primary shadow-pricing relative z-10  overflow-hidden rounded-r-xl bg-gradient-to-b to-[#006A67] py-10 px-8 text-center sm:p-12 lg:py-10 lg:px-6 xl:pt-[55px] xl:pb-10 xl:px-[50px]"
          >
            <div class="ml-20">
              <span
                class="inline-block px-6 py-2 mb-5 text-base font-semibold text-white uppercase border rounded-full"
              >
                POPULAR
              </span>
              <span
              ...
              <h2 class="mb-8 text-[28px] font-semibold text-white">
                € 19.99/mo
              </h2>

              <div class="flex flex-col gap-4 mb-16">
                <p class="text-base text-white">1 User</p>
                <p class="text-base text-white">All UI components</p>
                <p class="text-base text-white">Lifetime access</p>
                <p class="text-base text-white">Free updates</p>
                <p class="text-base text-white">Use on 1 (one) project</p>
                <p class="text-base text-white">3 Months support</p>
              </div>
              <div class="w-full">
                <a
                  href="javascript:void(0)"
                  class="text-primary inline-block rounded-full shadow-1 border border-white bg-white py-3 px-[50px] text-center text-base font-medium transition hover:bg-gray-2 hover:text-body-color"
                >
                  Purchase Now
                </a>
              </div>
  ...
  <!-- <section class="relative z-10 bg-primary py-20 lg:py-[120px]">
      <div class="container mx-auto">
        <div class="flex flex-wrap items-center -mx-4">
          <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div>
              <h2
                class="text-3xl font-bold text-white sm:text-4xl lg:text-3xl xl:text-[33px] 2xl:text-4xl"
              >
...
<div class="w-full px-4 lg:w-1/2 xl:w-7/12">
  <div class="flex flex-wrap items-center justify-center mt-12 lg:mt-0 xl:justify-end space-x-8">
    <a href="javascript:void(0)" 
       class="flex items-center justify-center py-5">
      <img
        src="src/images/logo_stifin.webp"
        alt="Logo STIFIn"
  ...
  <!-- <section x-data="{activeItem: 1}" class="pt-20 lg:pt-[120px] dark:bg-dark">
      <div class="container mx-auto">
        <div class="flex flex-wrap justify-center -mx-4">
          <div class="w-full px-4">
        ...
        <div class="flex flex-wrap justify-center -mx-4">
          <div class="w-full px-4 lg:w-10/12 xl:w-8/12 2xl:w-7/12">
            <div x-show="activeItem === 1">
              <div
                class="relative items-center rounded-lg bg-[#F8F9FF] dark:bg-dark-2 py-10 px-10 md:flex lg:px-[70px]"
              >
                <div
                  class="relative z-10 mb-12 h-[165px] w-full max-w-[165px] rounded-full md:mb-0"
                >
                  <img
                    src="src/assets/images/testimonials/testimonial-03/image-02.png"
                    alt="image"
                  ...
                  <div class="absolute -left-2 top-5 z-[-2]">
                    <svg
                      width="152"
                      height="152"
                      viewBox="0 0 152 152"
                ...
                <div class="w-full pl-0 md:pl-14">
                  ...
                  <h4 class="mb-1 text-lg font-semibold text-primary">
                    Healther Bennit
                  </h4>
                  <h6
                    class="text-sm italic font-normal text-body-color dark:text-dark-6"
                  >
                    Founder - Dailousm
                  </h6>
                </div>
                ...
                <div>
                  <span class="absolute -left-5 -bottom-5 z-[-1]">
                    <svg
                      width="77"
                      height="77"
                      viewBox="0 0 77 77"
                  ...
                  <span class="absolute -top-7 -right-4">
                    <svg
                      width="58"
                      height="60"
                      viewBox="0 0 58 60"
            ...
            <div x-show="activeItem === 2">
              ...
              >
                ...
                >
                  <img
                    src="src/assets/images/testimonials/testimonial-03/image-01.png"
                    alt="image"
                    class="w-full rounded-full"
                  />
                  <div class="absolute left-0 top-0 z-[-1]">
          ...
          <div class="w-full pt-12">
            <div class="flex items-center justify-center">
              <button
                @click="activeItem = 1"
                :class="activeItem === 1 ? 'bg-secondary' : 'bg-dark-7' "
                class="w-2 h-2 mx-4 rounded-full hover:bg-secondary"
              ></button>
              <button
                @click="activeItem = 2"
                :class="activeItem === 2 ? 'bg-secondary' : 'bg-dark-7' "
                class="w-2 h-2 mx-4 rounded-full hover:bg-secondary"
              ></button>
            </div>
          </div>
        ...
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div class="w-full mb-10">
              <div class="mb-8 overflow-hidden rounded">
                <img
                  src="src/assets/images/blogs/blog-01/image-01.jpg"
                  alt="image"
                  class="w-full"
                />
              </div>
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div class="w-full mb-10">
              <div class="mb-8 overflow-hidden rounded">
                <img
                  src="src/assets/images/blogs/blog-01/image-02.jpg"
                  alt="image"
                  class="w-full"
                />
              </div>
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div class="w-full mb-10">
              <div class="mb-8 overflow-hidden rounded">
                <img
                  src="src/assets/images/blogs/blog-01/image-03.jpg"
                  alt="image"
                  class="w-full"
                />
              </div>
        ...
        <div class="flex flex-wrap items-center -mx-4">
          <div class="w-full px-4 lg:w-1/2">
            ...
            <h2 class="mb-6 text-3xl font-bold leading-tight text-white sm:mb-8 sm:text-[38px] lg:mb-0">
              Lorem ipsum dolor, sit amet .<br class="hidden xs:block" />
              Lorem ipsum dolor sit amet.
            </h2>
          </div>
          <div class="w-full px-4 lg:w-1/2">
  ...
  <section>
    <div class="bg-white dark:bg-dark pt-20 pb-10 lg:pt-[110px] lg:pb-[70px]">
      <div class="container mx-auto">
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4 md:w-1/3">
            <div class="mb-10 text-center">
              <div
                class="mx-auto mb-5 flex h-[100px] w-[100px] items-center justify-center rounded-full bg-tg-bg dark:bg-white/5 text-primary sm:h-[130px] sm:w-[130px]">
              ...
              <div class="text-center">
                <h4 class="mb-3 text-lg font-semibold text-dark dark:text-white">
                  Email Address
                </h4>
                <p class="text-base text-body-color dark:text-dark-6">
                  info@example.com
    ...
    <div class="bg-tg-bg dark:bg-dark-2 py-20 lg:py-[120px]">
      <div class="container mx-auto">
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[510px] text-center lg:mb-20">
        ...
        <div x-data="chatbox()" class="bg-white dark: rounded-t-xl shadow-lg w-full h-[80vh] flex flex-col">
          <!-- Header -->
          <!-- <div class="bg-[#3A6F43] text-white p-4 rounded-t-xl flex items-center justify-between">
            <div class="flex items-center space-x-3">
              <div class="w-8 h-8 bg-white rounded-full flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-[#3A6F43]" viewBox="0 0 20 20"
                  fill="currentColor">
                  <path fill-rule="evenodd"
                    d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-6-3a2 2 0 11-4 0 2 2 0 014 0zm-2 4a5 5 0 00-4.546 2.916A5.986 5.986 0 005 10a6 6 0 0012 0c0-1.103-.298-2.14-.824-3.051A5 5 0 0010 11z"
                    clip-rule="evenodd" />
                </svg>
              </div>
              <div>
                <h1 class="font-semibold">Asisten AI</h1>
                <p class="text-sm text-white/80" x-text="statusText"></p>
              </div>
            </div>
            <button @click="toggleChat()" class="p-1 rounded-full hover:bg-white/20 transition-colors"
          ...
          <!-- Messages Container -->
          <!-- Messages -->
          <div class="flex-1 overflow-y-auto p-4 space-y-3 messages-container bg-white dark:bg-dark rounded-t-xl"
            x-show="isOpen" x-ref="messagesContainer">
            <div class="message-ai p-3 bg-[#3A6F43]/10 rounded-lg text-[#3A6F43] dark:bg-white/10 dark:text-white">
              <p>Halo! Saya adalah asisten AI. Ada yang bisa saya bantu?</p>
              <span class="text-xs text-gray-500 mt-1 block">10:30</span>
            </div>

            <div class="message-user p-3 bg-[#3A6F43] text-white rounded-lg">
              <p>Halo, bisakah kamu membantu saya?</p>
              <span class="text-xs text-white/70 mt-1 block">10:31</span>
            </div>

            <div class="message-ai p-3 bg-[#3A6F43]/10 rounded-lg text-[#3A6F43] dark:bg-white/10 dark:text-white">
              <p>Tentu saja! Saya siap membantu Anda dengan berbagai pertanyaan atau permintaan. Silakan tanyakan apa
                yang Anda butuhkan.</p>
              <span class="text-xs text-gray-500 mt-1 block">10:31</span>
            </div>


            <!-- Pesan masuk akan ditambahkan di sini -->
            <template x-for="message in messages" :key="message.id">
              <div class="p-3" :class="message.isUser ? 'message-user' : 'message-ai'">
                <p x-text="message.text"></p>
                <span class="text-xs mt-1 block" :class="message.isUser ? 'text-blue-200' : 'text-gray-500'"
                  x-text="message.time"></span>
              </div>
            </template>

            <!-- Typing indicator -->
            <div x-show="isTyping" class="message-ai p-3">
          ...
          <!-- Input Area -->
          <div class="border-t border-gray-200 dark:border-gray-600 p-4 bg-white dark:bg-[#2a4731]" x-show="isOpen">
            <form @submit.prevent="sendMessage()" class="flex space-x-2">
              <div class="flex-1 relative">
                <textarea x-ref="messageInput" x-model="newMessage" @keydown.enter.prevent="sendMessage()"
                  @input="autoResize()" placeholder="Ketik pesan Anda..."
                  class="w-full border border-gray-300 dark:border-gray-500 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#3A6F43] dark:focus:ring-white bg-white dark:bg-[#2a4731] text-gray-800 dark:text-white resize-none !scrollbar-none"
                  rows="1" style="overflow:hidden;"></textarea>
              </div>
              <button type="submit"
                class="bg-[#3A6F43] text-white rounded-lg p-2 hover:bg-[#2d5233] transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed"
      ...
      <div class="flex flex-wrap -mx-4">
        <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
          <div class="w-full mb-10">
            <a href="javascript:void(0)" class="mb-6 inline-block max-w-[160px]">
              ...
              <img src="src/images/favicon_stifin.webp" alt="logo" class="hidden max-w-full dark:block" />
            </a>
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
          <div class="w-full mb-10">
            ...
            <form class="relative w-full mb-5 overflow-hidden rounded">
              <input type="email" placeholder="Your Email"
                class="w-full h-12 px-5 text-sm bg-transparent border rounded outline-none border-stroke text-body-color dark:text-dark-6 dark:border-dark-3 focus:border-primary dark:focus:border-primary focus-visible:shadow-none" />
              <button type="submit"
  ...
  <script>
    ...
    function chatbox() {
      return {
        ...
        newMessage: '',
        isTyping: false,
        messageCount: 3, // Pesan awal sudah ada 3

        init() {
          // Scroll ke bawah saat komponen dimuat
          this.$nextTick(() => {
            this.scrollToBottom();
          });
        },
        ...
        get statusText() {
          return this.isOpen ? 'Online' : 'Offline';
        },
        ...
        sendMessage() {
          ...
          // Scroll ke bawah dan simulasi balasan AI
          this.$nextTick(() => {
            this.scrollToBottom();
        ...
        simulateAIReply() {
          ...
          // Scroll ke bawah untuk menunjukkan indikator mengetik
          this.$nextTick(() => {
            this.scrollToBottom();
          });
          ...
          setTimeout(() => {
            const aiReplies = [
              "Terima kasih atas pesan Anda. Saya memahami permintaan Anda.",
              ...
              "Saya memerlukan informasi lebih lanjut untuk membantu Anda lebih baik."
            ];
            ...
            // Scroll ke bawah setelah AI membalas
            this.$nextTick(() => {
              this.scrollToBottom();
            });
          }, 1500);
