...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>STIFIn Report | {{type}}</title>
...
<div class="pointer-events-none fixed inset-0 z-70 min-h-screen bg-black bg-opacity-70 opacity-0 transition-opacity lg:hidden" :class="{ &#39;opacity-100 pointer-events-auto&#39;: mobileMenu }">
  <div class="absolute right-0 min-h-screen w-2/3 bg-primary py-4 px-8 shadow md:w-1/3">
    ...
    <ul class="mt-8 flex flex-col">
      ...
      <div><div class="relative bg-cover bg-center bg-no-repeat py-8" style="background-image: url('./src/images/bg-hero.jpg')">
      ...
      <div class="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
        ...
        <div class="flex flex-col justify-center pt-3 sm:flex-row sm:pt-5 lg:justify-start">
          <div class="flex items-center justify-center pl-0 sm:justify-start md:pl-1">
            <p class="font-body text-lg uppercase text-white">Let's connect see your test report!</p>
          </div>
        </div>
      </div>
    </div>
...
<div class="container py-16 md:py-20" id="services">
  ...
  <h3 class="pt-6 text-center font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl">
    These are some recommendation for {{ type }} like you!
  </h3>
...
<div class="bg-cover bg-top bg-no-repeat pb-16 md:py-16 lg:py-24" style="background-image: url(./src/images/experience-figure.png)" id="statistics">
  <div class="container">
    ...
    <div class="mx-auto grid w-full grid-cols-1 gap-6 pt-12 sm:w-3/4 lg:w-full lg:grid-cols-3 xl:gap-10">
      <a href="https://atom.redpixelthemes.com/post" class="shadow">
        ...
        <div class="bg-white py-6 px-5 xl:py-8">
          ...
          <span class="block pt-2 font-body text-grey-20">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
...
<div class="relative bg-primary bg-cover bg-center bg-no-repeat py-16 bg-blend-multiply lg:py-24" style="background-image: url(/bg-cta.jpg)">
  <div class="container relative z-30">
    <h3 class="text-center font-header text-3xl uppercase leading-tight tracking-wide text-white sm:text-4xl lg:text-5xl">
      Want to know more about <span class="font-bold">{{ type }}</span> <br>
      Contact us now!
    </h3>
    <form class="mt-6 flex flex-col justify-center sm:flex-row">
      <input class="w-full rounded px-4 py-3 font-body text-black sm:w-2/5 sm:py-4 lg:w-1/3" type="text" id="email" placeholder="Say what u want to know">
      <button class="mt-2 rounded bg-yellow px-8 py-3 font-body text-base font-bold uppercase text-primary transition-colors hover:bg-primary hover:text-white focus:border-transparent focus:outline-none focus:ring focus:ring-yellow sm:ml-2 sm:mt-0 sm:py-4 md:text-lg">
        Ask Us!
      </button>
    </form>
  </div>
  ...
  <div class="container flex flex-col justify-between py-6 sm:flex-row">
    ...
    <script src="./src/js/main.js.download"></script>

    
    <script src="https://guanaco.redpixelthemes.com/script.js" data-site="KRXZMJGY" defer=""></script>
